...
export default function Planes() {
  return (
    <section
      id="planes"
      className="relative w-full min-h-screen bg-gradient-to-b from-teal-800 via-teal-900 to-blue-900 px-10 py-10 overflow-x-hidden"
    >
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-2">
            <motion.div
                ...
                className="relative flex items-center justify-between mx-8 my-5">
                <div>
